...
//
//    max_fast_bin = (ap->fast_bins).index(DEFAULT_MAX_FAST);
//
...
//    top_size = ap->top_chunk->get_size();
//
...
//        */
//        && (offset2Chunk(p, size) != ap->top_chunk)
//#endif
//            ) {
//
...
//    */
//
//    if (DEFAULT_MAX_FAST != 0) { // 这里是已经被初始化了，如果没有被初始化我们就初始化，然后返回
